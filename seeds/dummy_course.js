    ...
    .then(function () {
      ...
      return knex('course').insert([
        ...
        return knex('course_schedule').insert([
          {id:1,start_date:new Date(Date.now()),course_id:1,instructor_id:1},
          {id:2,start_date:new Date(Date.now()+1000*60*60*24*5),course_id:3,instructor_id:2},
          {id:3,start_date:new Date(Date.now()+1000*60*60*24*10),course_id:5,instructor_id:3},
          {id:4,start_date:new Date(Date.now()+1000*60*60*24*15),course_id:3,instructor_id:1},
          {id:5,start_date:new Date(Date.now()+1000*60*60*24*20),course_id:5,instructor_id:2}
        ])
      }).then(()=>{
